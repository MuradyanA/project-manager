<div class="mb-[2%] mx-auto w-[98%] bg-gray-100 h-screen items-center">
    <div class="w-full bg-white p-8 rounded-lg shadow-lg h-fit mt-[2%]">
        <h1 class="text-center text-5xl font-bold mb-4 text-blue-500">Project - {{ $currentRequest->title }}</h1>
    ...
    {{-- <div class="flex flex-col items-center">
        <div class="bg-gray-100 rounded-lg p-4 w-full">
            ...
            <!-- Comment Form -->
            <form wire:submit="addComment" class="flex flex-col space-y-2">
                <textarea wire:model.live="comment"
                    class="w-full h-12 px-3 py-1 rounded-md border border-gray-300 focus:outline-none focus:border-indigo-500"
                    placeholder="Write your comment here..."></textarea>
                <button type="submit"
                    class="bg-indigo-500 text-white px-3 py-1 rounded-md hover:bg-indigo-600 transition duration-300">Submit
                    Comment</button>
            </form>
                    ...
                    <div class="flex flex-col bg-white rounded-md p-2 shadow-md">
                        <div class="flex items-center justify-between mb-1">
                            <div class="flex items-center">
                                <p class="text-lg text-gray-800 font-semibold">{{$comment->commenterName}}</p>
                            </div>
                            <div class="flex items-center">
                        ...
                        <p class="text-md text-gray-800">{{$comment->comment}}</p>
                        <hr class="my-[1%]">
                        <span class="text-sm text-gray-500 mt-[1%]">{{$comment->created_at->format('Y-m-d H:i')}}</span>
                    </div>
